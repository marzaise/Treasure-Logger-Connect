...
void setup()
{
    ...
    free(BlackImage);
    printf("show Gray------------------------\r\n");
    UWORD Imagesize = ((EPD_2IN7_V2_WIDTH % 4 == 0)? (EPD_2IN7_V2_WIDTH / 4 ): (EPD_2IN7_V2_WIDTH / 4 + 1)) * EPD_2IN7_V2_HEIGHT;
    ...
    */
    ...
    for (int i=0; i<2904; ++i)
        arr[i] = 0b00000000; //black

    for (int i=2904; i<2904*2; ++i)
        arr[i] = 0b01010101; //dark gray

    for (int i=2904*2; i<2904*3; ++i)
      arr[i] = 0b10101010; //light gray

    for (int i=2904*3; i<2904*4; ++i)
      arr[i] = 0b11111111; //white
